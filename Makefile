...
all: stack_ua queue_ua circular_queue_ua singly stack_ull queue_ull doubly
...
install: stack_ua queue_ua circular_queue_ua stack_ull singly queue_ull doubly
	./doubly
